...
const Header = () => {
  ...
  return (
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 p-3 md:px-5 bg-white dark:bg-black">
      {loading && <Loader />}
      ...
      <div className="flex items-center">
        <div className="md:flex md:items-center">
          ...
          <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4 cursor-pointer">
            <img
              src="https://media.licdn.com/dms/image/D5603AQGs_PTHe7kGsw/profile-displayphoto-shrink_800_800/0/1664995393267?e=1689206400&v=beta&t=nw9mrWyvMswSbwwPZ_jwCR5rMHlH8cpbKJ1NrgpiKJQ"
              alt=""
            />
          </div>
        </div>
